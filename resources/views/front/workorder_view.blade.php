		...
		{{-- Workorder Post start --}}
			...
			<div class="col-md-12" style="margin-top: -18px">
				<div class="col-md-4">
					...
					<a href="{{route('edit_workorder',$w->id)}}" class="btn-sm btn btn-success"><i class="fas fa-edit"></i></a>
				...
				<div class="col-md-4" style="margin-left: -25px">
					<form action="{{route('delete_workorder',$w->id)}}" method="post">
						...
						<button type="submit" class="btn-sm btn btn-danger" onclick="return confirm('Are You Sure???')"><i class="fas fa-trash"></i></button>
						
					</form>
								
				  </div>
				<div class="col-md-4" style="margin-left: -25px">
					<a href="{{route('workorderPostInd',$w->id)}}" class="btn btn-info"><i class="fa-solid fa-inbox-in"></i></a>
