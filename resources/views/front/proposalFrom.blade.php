            ...
            <table class="table table-bordered">
                <tr> 
                    ...
                    <td >{{$machinePost->title}}
                        ...
                        <input type="hidden" name="machinepost" value="machinePost">
                    ...
                    <td >
                        <select name="machinepost_id" id="" class="form-control wide">
                            ...
                            @if ($post->userMachine->company_id==Auth::user()->company_id)
                                 <option value="{{$post->id}}">{{$post->title}}</option>
                            @endif
                    ...
                    <td >{{$workOrder->title}}
                        ...
                        <input type="hidden" value="workorderPost" name="workorder">
