...
<br><br><br>
      <div class="col-md-8 col-xl-6" style="margin-top: 20px;margin-bottom: 50px">
        ...
        {{-- <div class="row"> --}}
            ...
            <div class="col-md-4">
            <br><br>
                <img src="@if($w_details){{asset('photos/company/'.$w_details->Companies->photo)}} @else {{asset('photos/deals/workorder.jpg')}} @endif" alt="" class="img-responsive">
...
<br><br><br>
      ...
      @endphp
              <div class="utf_grid_job_widget_area"> <span class="job-type full-type">Post Date : @if($date){{$date}}@endif</span>
                ...
                <div class="u-content">
                  <div class="avatar box-80"> <a href="{{route('mechinePostDetails',$ww->id)}}" target="_blank"> <img class="img-responsive" src="{{asset('photos/company/'.$ww->usermachine->company->photo)}}" alt=""> </a> </div>
                  <h5><a href="{{route('mechinePostDetails',$ww->id)}}">{{$ww->title}}</a></h5>
                ...
                <div class="utf_apply_job_btn_item"> <a href="{{route('mechinePostDetails',$ww->id)}}" target="_blank" class="btn job-browse-btn btn-radius br-light">View Machine Post</a> </div>
              </div>
            </div>
            {{-- @endif --}}
        @endforeach
