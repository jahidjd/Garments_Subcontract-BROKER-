...
Route::get('/machineProposalInd/{id}', [App\Http\Controllers\Front::class, 'machineProposalInd'])->name('machineProposalInd');
Route::get('/workorderPostInd/{id}', [App\Http\Controllers\Front::class, 'workorderPostInd'])->name('workorderPostInd');
Route::get('/acceptProposal/{id}', [App\Http\Controllers\Front::class, 'acceptProposal'])->name('acceptProposal');
